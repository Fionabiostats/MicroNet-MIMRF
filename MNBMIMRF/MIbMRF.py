...
(M)utual (I)nformation (b)ased (M)arkov (R)andom (F)eild

MIbMRF is used to infer a pairwise association between taxon and taxon, then we can estabulish a micrbial network which its vertix are taxa and its edges are pairwise dependencies. 
